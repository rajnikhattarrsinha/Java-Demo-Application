node{
      ...
      stage('Deploy To K8s'){
         ...
         withCredentials([string(credentialsId: 'k8pwd', variable: 'k8PWD')]) {
          ...
          sh "sshpass -p ${k8PWD} scp -r deployment.yaml ubuntu@104.211.187.75:/home/ubuntu" 
          sh "sshpass -p ${k8PWD} ssh  -o StrictHostKeyChecking=no ubuntu@104.211.187.75 ${k8Apply}"
         }
       }
